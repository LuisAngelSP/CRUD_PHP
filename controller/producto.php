        ...
        case "Guardaryeditar" :
            ...
            if(empty($_POST["prod_id"])){
                ...
                if(is_array($datos)==true and count($datos)==0){
                    $producto->insert_producto($_POST["cat_id"],$_POST["prod_nom"],$_POST["prod_desc"],$_POST["prod_cantidad"]);
                }  
            }else{
                $producto->update_producto($_POST["prod_id"],$_POST["cat_id"],$_POST["prod_nom"],$_POST["prod_desc"],$_POST["prod_cantidad"]);
            }      
        ...
        case "mostrar" :
            ...
            if(is_array($datos)==true and count($datos)>0){
                foreach($datos as $row){
                    ...
                    $output["prod_cantidad"] = $row["prod_cantidad"];
                }
